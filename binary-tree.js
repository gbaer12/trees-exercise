/** Binary Tree node: node for a general tree. */
...
class BinaryTree {
  ...
  /** minDepth(): return the minimum depth of the tree -- that is, the length of the shortest path from the root to a leaf. */
  ...
  /** maxDepth(): return the maximum depth of the tree -- that is, the length of the longest path from the root to a leaf. */
  ...
  /** nextLarger(lowerBound): return the smallest value in the tree which is larger than lowerBound. Return null if no such value exists. */
  ...
  /** areCousins(node1, node2): determine whether two nodes are cousins (i.e. are at the same level but have different parents.) */
  ...
  /** serialize(tree): serialize the BinaryTree object teee into a string.
   *
   * Output looks like this:
   * 1 2 # # 3 4 # # 5 # #
   * Where # represents # chldren with a pre-order traversal.
   */
  ...
  /** lowestCommonAncestor(node1, node2): find the lowest common ancestor of the two nodes ina binary tree. */
